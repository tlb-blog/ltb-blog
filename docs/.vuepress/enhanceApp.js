    ...
    mounted() {
      ...
      const addCategoryNav = () => {
        ...
        nav.innerHTML = `
            ...
            <a href="${basePath}post/shose/"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" class="bi bi-shoe-prints me-2" aria-hidden="true">
